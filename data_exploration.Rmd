...
```{r WA-Water-Systems-By-owner-Type-Box0, cache=FALSE, fig.cap="Washington State Water Systems by Owner Type"}
...
```{r WA-Water-Systems-By-owner-Type-Box1, cache=FALSE, fig.cap="Washington State Water Systems by Owner Type"}
...
```{r WA-Water-Systems-By-owner-Type-Box2, cache=FALSE, fig.cap="Washington State Water Systems by Owner Type"}
# Add colors for population groups
...
```{r WA-Water-Systems-By-owner-Type-Box3, cache=FALSE, fig.cap="Washington State Water Systems by Owner Type"}
...
```{r WA-Water-Systems-By-owner-Type-Box4, cache=FALSE, fig.cap="Washington State Water Systems by Owner Type"}
# Add lines (and labels) for the various US levels (HHS and EPA)
...
```{r, WA-Water-Systems-over-EPA-MCL, cache=FALSE, fig.cap="Washington State Water Systems Exceeding EPA MCL of 4 mg/L", fig.height=3, fig.width=7}
